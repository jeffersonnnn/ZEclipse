...
// Das instructions-Modul - wird vom Anchor-Makro erwartet
// Lösung: Wir behalten diesen Namen bei, aber vermeiden direkte Typ-Konflikte
pub mod instructions;

// Importe für die Programmfunktionen
