//! BlackoutSOL - Entrypoint für die Anchor-Integration

use anchor_lang::prelude::*;

declare_id!("B1ack111111111111111111111111111111111111111");

// Import der Anchor-Strukturen für Programmfunktionen
...
// Import des eigentlichen Moduls für die Implementierung
use crate::instructions;

/// Hauptprogramm-Modul, das vom Anchor-Framework verarbeitet wird
#[program]
pub mod blackout {
    use super::*;

    /// Initialisiert einen neuen anonymen Transfer
    pub fn initialize(
