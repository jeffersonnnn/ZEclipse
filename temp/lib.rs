...
// Explizites Ausblenden von solana_program, damit wir vollständige Pfade verwenden müssen
// und keine Namenskonflikte mit instructions auftreten
use anchor_lang::solana_program;

// Programm-ID für BlackoutSOL
declare_id!("B1ack111111111111111111111111111111111111111");

// Basis-Module des Programms
pub mod errors;
pub mod state;
pub mod utils;
...
// Instruktionsmodul - nicht umbenannt, weil Anchor es so erwartet
// Wir vermeiden Namenskonflikte, indem wir immer vollständige Pfade verwenden
pub mod instructions;

// Explizite Importe der Kontextstrukturen für die Programmfunktionen
...
// Anchor-Programmdefinition mit allen Entry Points
#[program]
pub mod blackout {
    use super::*;
    ...
    pub fn initialize(
        ...
        // Aufruf mit vollständig qualifiziertem Pfad direkt aus dem Modul
