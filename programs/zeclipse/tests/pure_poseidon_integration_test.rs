...
mod integration_tests {
    ...
    fn test_poseidon_validation_across_layers() {
        ...
        let bridge_test = zeclipse::pure_poseidon::bridge::validate_poseidon_parameters();
    ...
    fn test_hex_conversions() {
        use zeclipse::pure_poseidon::constants::scalar_from_hex;
    ...
    #[test]
    fn test_mds_matrix() {
        use zeclipse::pure_poseidon::constants::get_mds_matrix;
