# ZEclipse Kryptographische Test-Vektoren

*Erstellt am: 16. Mai 2025, 23:42 Uhr*

Diese Datei enthält definitive Test-Vektoren für die kryptografischen Kernfunktionen des ZEclipse-Protokolls. 
...
Die folgenden Test-Vektoren validieren die korrekte Implementierung der Poseidon-Hash-Funktion in ZEclipse.
...
Die folgenden Test-Vektoren validieren die korrekte Implementierung der Bloom-Filter-Operationen in ZEclipse.
...
Die folgenden Test-Vektoren validieren die korrekte Implementierung der PDA-Validierungslogik in ZEclipse.
...
1. `/programs/zeclipse/tests/poseidon_test_vectors.rs` - Für Poseidon-Hash-Tests
2. `/programs/zeclipse/tests/bloom_filter_test_vectors.rs` - Für Bloom-Filter-Tests
3. `/programs/zeclipse/tests/pda_validation_test_vectors.rs` - Für PDA-Validierungstests
...
```bash
# Im CI/CD-Skript
cargo test --package zeclipse --test poseidon_test_vectors
cargo test --package zeclipse --test bloom_filter_test_vectors
cargo test --package zeclipse --test pda_validation_test_vectors
```
...
```bash
cd /Users/christopher/CODE2/ZEclipse
cargo test --package zeclipse --test '*_test_vectors'
```
