// Processor module for handling all ZEclipse instructions
...
pub fn process_instruction(
    ...
    // In reality, all functionality is provided by the zeclipse-anchor crate
    ...
    msg!("ZEclipse: Direct call not supported. Please use the Anchor integration.");
